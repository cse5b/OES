...
<c:if test='${not empty param["ExamExists"]}'>
 ...
 <p style="color:red;font-weight:bold;">Data Not Found</p>
</c:if>
                    <form action="examsentry" id="contact-form" class="form-horizontal" method="post">
                         ...
                         <div class="control-group">
                                                                              ...
                                                                              <div class="controls">
                                                                                  <div class="input-prepend">
                                                        <span class="add-on"><i class="icon-barcode"></i></span>
                                                                                <input type="text" class="input-large" name="sdate" id="sdate" required="true" placeholder="YYYY-MM-DD HH:MM:SS "value="YYYY-MM-DD HH:MM:SS"/>
                                                                              </div>
                                                                            </div>
                                 </div>
                         <div class="control-group">
                                                                              ...
                                                                              <div class="controls">
                                                                                  <div class="input-prepend">
                                                        <span class="add-on"><i class="icon-barcode"></i></span>
                                                                                <input type="text" class="input-large" name="edate" id="edate" required="true" placeholder="YYYY-MM-DD HH:MM:SS" value="YYYY-MM-DD HH:MM:SS"/>
                                                                              </div>
                                                                            </div>
                                 </div>
                        <div>
...
active
                    ...
                    ">
   <c:if test='${not empty param["ErrorUpdate"]}'>
 <p style="color:red;font-weight:bold;">No Data Found</p>
</c:if>
                    <form action="updatepaper.jsp" id="contact-form" class="form-horizontal" method="post">
                          ...
                          <div class="control-group">
                                              ...
                                              <div class="controls">
                                                  <div class="input-prepend">
                                                    <span class="add-on"><i class="icon-barcode"></i></span>
                                                <input type="text" class="input-large" name="qno" id="qno" required="true" placeholder="Question No"/>
                                              </div>
                                            </div>
                                 </div>
