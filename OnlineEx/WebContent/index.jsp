     ...
     <div id="maincontent" class="span5 pull-right ">
         <ul class="nav nav-tabs nav-justified">
          ...
          <ul class="dropdown-menu" role="menu" aria-labelledby="myTabDrop1">
            ...
            <li><a href="#dropdown3" tabindex="-1" data-toggle="tab">As Admin</a></li> 
          </ul>
        </li>
        </ul>
 <div id="myTabContent" class="tab-content">
<div id="student" class="tab-pane
<c:if test='${!((not empty param["existsFaculty"])  ||  (not empty param["RetryFaculty"]) || (not empty param["RegisterFaculty"]) || (not empty param["existsStudent"]) || (not empty param["RetryStudent"]) || (not empty param["RegisterStudent"]))}'>
active
</c:if>
...
">
        ...
        <form action='<%= response.encodeURL("adminlogin") %>' id="contact-form7" class="form-horizontal" method="post">
						    <div class="control-group">
